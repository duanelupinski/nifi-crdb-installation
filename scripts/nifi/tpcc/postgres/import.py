...
path = '{0}/{1}/schema.dump'.format(data_folder, tpcc_warehouses)
if not os.path.isfile(path):
    sys.stdout.write('false')
else:
    os.system('{0}/tpcc/postgres/import.sh {1} {2} {3} {4} {5} {6} {7} > /dev/null'.format(scripts_folder, instance_address, tpcc_warehouses, data_folder, terraform_path, provider, key_name, key_user))

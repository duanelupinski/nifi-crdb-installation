...
locals {
  aws_security_group_rules = [
    ...
    {
      type        = "ingress"
      description = "ext-crdb-management"
      from_port   = 8080
      to_port     = 8080
      protocol    = "tcp"
      cidr_blocks = [var.ip_range]
    ...
    {
      type        = "ingress"
      description = "int-crdb-management"
      from_port   = 8080
      to_port     = 8080
      protocol    = "tcp"
      cidr_blocks = ["10.0.0.0/8"]
